  ...
  public class TransformTweenBehaviour : MonoBehaviour {
    ...
    public void PlayForward() {
			if(PlayerVRControllerLeap.getSingleton() != null)
				PlayerVRControllerLeap.getSingleton().setPalmFace(false);
      PlayTween(Direction.Forward);
    }

    public void PlayBackward() {
	  //NOTIFICO AL PLAYER CHE IL PALMO DELLA MANO E' RIVOLTO VERSO AVANTI.
	  if(PlayerVRControllerLeap.getSingleton() != null)
		PlayerVRControllerLeap.getSingleton().setPalmFace(true);
